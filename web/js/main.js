...
//     //setup the app
//     angular.module('myApp', ['ui.router', 'ui.bootstrap', 'ui.slider',
//      'rzModule', 'templatescache', 'simplecolorpicker', 'imgpreload', 
//      'perfect_scrollbar', 'angularFileUpload', 'ngSanitize', 'LocalStorageModule',
//       'angularSpectrumColorpicker', 'ui.spinner', 'countrySelect', 'gettext']);
//     angular.module('myApp').constant('_', window._);

// 	angular.module('myApp').run(function (gettextCatalog, ApiService) {
