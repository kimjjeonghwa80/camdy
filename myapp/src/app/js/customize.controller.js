// angular.module('app.controller').controller('DesignerController', function($rootScope,
//  $stateParams, $location, $scope, $state, $http, ApiService, ProductService, 
//  CanvasService, CartService, $modal, localStorageService, PriceService,
//  FontService, gettextCatalog) {
//     this.$state = $state;
...
//     $rootScope.canvasService = CanvasService;
...
//             $scope.zoom = 1; 
//         }
//         $rootScope.canvas.setZoom($scope.zoom);
//         $scope.drawCanvas();
//         $scope.zoomCanvas();
//     };
...
//         var scale = width / $rootScope.canvas.getWidth();
//         height = scale * $rootScope.canvas.getHeight();

//         $rootScope.canvas.setDimensions({
//             "width": width,
//             "height": height
//         });

//         $rootScope.canvas.calcOffset();
//         $rootScope.canvas.setZoom($scope.zoom);
//         $scope.drawCanvas();
//         if($scope.zoom == 1) {
...
//             var prevWidth = $rootScope.canvas.getWidth();
//             var prevHeight = $rootScope.canvas.getHeight();

//             $rootScope.canvas.setWidth($scope.selectedOrientationDimensions.printableWidth);
//             $rootScope.canvas.setHeight($scope.selectedOrientationDimensions.printableHeight);
...
//             orientationCanvas = $rootScope.canvas;
//         } else {
            
//             // parse the data into the canvas
//             orientationCanvas = $scope.currentItem.canvases[$scope.selectedOrientation];
//             $rootScope.canvas.loadFromJSON(orientationCanvas);
...
//         CartService.updateItemCanvas($scope.selectedOrientation, $rootScope.canvas, CartService.selectedItemId);
//     };
...
//             object.bringToFront();
//             //$rootScope.canvas.item($scope.editableItem).bringToFront();
//         }        

//         if(command == 'sendBackwards') {
//             object.sendBackwards();
//             //$rootScope.canvas.item($scope.editableItem).sendBackwards();
//         }        

//         if(command == 'bringForward') {
//             object.bringForward();
//             //$rootScope.canvas.item($scope.editableItem).bringForward();
//         }        

//         if(command == 'sendToBack') {
//             object.sendToBack();
//             //$rootScope.canvas.item($scope.editableItem).sendToBack();
//         }
//         //canvas.renderAll();
//         //$scope.drawCanvas();
...
//         CanvasService.setOrientationDesign($scope.selectedOrientation, $rootScope.canvas);
//         CartService.updateItemCanvas($scope.selectedOrientation, $rootScope.canvas, CartService.selectedItemId);
//     }
...
//         if($rootScope.canvas.getObjects().length > 0) { //only set orientation if we have at least 1 element
