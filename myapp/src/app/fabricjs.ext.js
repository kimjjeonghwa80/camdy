...
topLeftImage.src = 'app/css/images/fa_times.png'

var topRightImage = new Image()
topRightImage.src = 'app/css/images/fa_rotate.png'

var bottomRightImage = new Image()
bottomRightImage.src = 'app/css/images/fa_resize.png'

var bottomLeftImage = new Image()
bottomLeftImage.src = 'app/css/images/fa_layers.png'
...
function deleteObject () {
  ...
  confirm({
    ...
    confirm: function () {
     ...
     // var remainingObjects = scope.canvas.getObjects()
     // scope.canvas.clear()
